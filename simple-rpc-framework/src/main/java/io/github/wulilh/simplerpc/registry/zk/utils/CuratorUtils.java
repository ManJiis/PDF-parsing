package io.github.wulilh.simplerpc.registry.zk.utils;
...
public final class CuratorUtils {
    ...
    public static void createPersistentNode(CuratorFramework zkClient, String path) {
        try {
            if (REGISTERED_PATH_SET.contains(path) || zkClient.checkExists().forPath(path) != null) {
                ...
                //eg: /simple-rpc/github.javaguide.HelloService/127.0.0.1:9999
    ...
    public static CuratorFramework getZkClient() {
        ...
        // TODO: 2023/2/28
        Properties properties = ComUtils.readPropertiesFile("simple-rpc.properties");
        String zookeeperAddress = properties != null && properties.getProperty("zookeeper.address") != null
                ? properties.getProperty("zookeeper.address") : DEFAULT_ZOOKEEPER_ADDRESS;
